...
import 'package:Petamin/call/cubit/call_state.dart';
import 'package:Petamin/call_widgets/default_circle_image.dart';
import 'package:Petamin/call_widgets/user_info_header.dart';
...
class CallScreen extends StatefulWidget {
  ...
  const CallScreen(
      ...
      : super(key: key);
  // static Page<void> page() => const MaterialPage<void>(child: CallScreen());
  @override
...
class _CallScreenState extends State<CallScreen> {
                              ...
                              : Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image: widget.callModel.callerAvatar!
                                              .isNotEmpty
                                          ? NetworkImage(
  ...
  Widget _remoteVideo({required int remoteUserId}) {
    return RtcRemoteView.SurfaceView(
      uid: remoteUserId,
      channelId: /*widget.callModel.channelName!*/ agoraTestChannelName,
    );
  }
}
