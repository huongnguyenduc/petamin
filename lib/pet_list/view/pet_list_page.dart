...
class PetListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void onGoBack(int tab) {
      debugPrint('onGoBack');
      cubit..getPets();
      userCubit..getMyUserprofile();
    }
                                      ...
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                            ...
                                            child: PetCard(
                                              data: PetCardData(
                                                petId: state
                                                    .adoptList[index].petId!,
                                                adoptId:
                                                    state.adoptList[index].id!,
                                                age: state
                                                    .adoptList[index].pet!.year
                                                    .toString(),
                                                name: state.adoptList[index]
                                                    .pet!.name!,
                                                photo: state.adoptList[index]
                                                    .pet!.avatarUrl!,
                                                breed: state.adoptList[index]
                                                    .pet!.breed!,
                                                sex: state.adoptList[index].pet!
                                                    .gender!,
                                                price: state
                                                    .adoptList[index].price!,
                                              ),
                                            ));
                                      },
                                      itemCount: state.adoptList
                                          .length, // TODO: Change to real data
                                    );
                                  }),
                            ]),
                          ),
